      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Lade deine Excel-Datei hoch zur Überprüfung durch den Administrator
          </p>
        </div>
            ...
            <div className="ml-3">
              ...
              <div className="text-sm text-orange-700">
                ...
                <p className="mt-3 text-xs bg-orange-100 p-2 rounded">
                  <strong>Wichtig:</strong> Nach dem Upload wird deine Datei vom
                  Administrator manuell überprüft und freigegeben. Du erhältst
                  eine Benachrichtigung über den Status deiner Übermittlung.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    💡 Tipp: Lade die Dummy-Excel-Vorlage herunter und nutze sie
                    als Basis
                  </p>
                </div>
              </div>
